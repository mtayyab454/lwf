...
# Task1 options
parser.add_argument('--epochs-t1', default=200, type=int, metavar='N',
                    help='number of total epochs to run')
parser.add_argument('--schedule-t1', type=int, nargs='+', default=[100, 150],
